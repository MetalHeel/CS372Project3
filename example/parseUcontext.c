...
int main(int argc, char **argv)
{
  ...
  printf("The memory address of uc_stack.ss_sp in probeUCStack is 0x%x\n", (unsigned int)(anotherSample));
  printf("The memory address of uc_stack.ss_sp in main is 0x%x\n", (unsigned int)(mycontext.uc_stack.ss_sp));
  /* 
   ...
   */
  unsigned int errS = (unsigned int)(mycontext.uc_mcontext.gregs[REG_EBP] - sizeof(mycontext)/4);
  //unsigned int argS = (unsigned int) (mycontext.uc_mcontext.gregs[REG_EBP] + 2*sizeof(unsigned int)/4);
  printf("The memory address of the local variable err is 0x%x\n", (unsigned int)(mycontext.uc_mcontext.gregs[REG_EBP] - sizeof(mycontext)/4));

  printf("The memory address of the argument argc is 0x%x\n", (unsigned int) (mycontext.uc_mcontext.gregs[REG_EBP] + 2*sizeof(unsigned int)/4));
  ...
  unsigned int espS = (unsigned int)mycontext.uc_mcontext.gregs[REG_ESP];
